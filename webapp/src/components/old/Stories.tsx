      ...
      <Container maxWidth="container.xl">
        ...
        >
          <Box align="center" w="100%">
            ...
            <Box maxW="700px">
              People on TMS have fostered community, learned new skills,
        ...
        <Grid mt="10" mb="40" templateColumns="repeat(3, 1fr)" gap={6}>
          ...
          <Box width="100%" align="left">
            ...
            <Box>
              Since TMS began nearly 20 years ago, we’ve fostered connections
